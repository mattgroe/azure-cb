...
- Navigate to `az-bot-test` folder
- Select `az-bot-test.bot` file
...
msbot clone services --name "az-bot-test" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
